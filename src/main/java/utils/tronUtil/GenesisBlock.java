...
public class GenesisBlock implements Serializable {
  ...
  @Getter
  private List<Protocol.Account> assets;

  @Getter
  private List<Protocol.Witness> witnesses;
  ...
  public static GenesisBlock getDefault() {
    ...
    List<Protocol.Account> assets = Collections.emptyList();
    genesisBlock.setAssets(assets);
    List<Protocol.Witness> witnesses = Collections.emptyList();
  ...
  public void setAssets(final List<Protocol.Account> assets) {
    this.assets = assets;
  ...
  public void setWitnesses(final List<Protocol.Witness> witnesses) {
